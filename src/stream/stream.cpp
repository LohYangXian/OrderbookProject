...
// Open a file to log incoming messages
std::ofstream snapshot_file("orderbook_snapshot.json", std::ios::app);

// Message handler: print incoming JSON payloads
void on_message(websocketpp::connection_hdl, client::message_ptr msg) {
    //Save each message as a line in the file
    snapshot_file << msg->get_payload() << std::endl;
